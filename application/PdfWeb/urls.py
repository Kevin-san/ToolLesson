...
urlpatterns = [
    ...
    url(r'^(novel|learn)/book/upload/submit/$',views.book_upload_submit,name='book_upload'),
    url(r'^(image|audio|video|vhider)/media/index',views.media_index,name='media_index'),
    url(r'^(image|audio|video|vhider)/media/(\d+)/(\d+)/$',views.media_list,name='media_list'),
    url(r'^(image|audio|video|vhider)/media/content/(\d+)/(\d+)/$',views.media_content,name='media_content'),
    url(r'^(image|audio|video|vhider)/media/download/(\d+)/$',views.media_download,name='media_download'),
