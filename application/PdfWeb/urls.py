...
urlpatterns = [
    ...
    url(r'^image/index',views.image_index,name='image_index'),
    url(r'^image/(\d+)/(\d+)/$',views.image_list,name='image_list'),
    url(r'^image/content/(\d+)/$',views.image_content,name='image_content'),
    ...
    url(r'^([novel|learn])/book/menuupd/submit/$',views.book_upd_submit,name='book_upd_submit'),
    url(r'^([novel|learn])/book/menudel/(\d+)/$',views.book_menudel,name='book_menudel'),
    url(r'^([novel|learn])/book/menuadd/submit/$',views.book_add_submit,name='book_add_submit'),
    url(r'^([novel|learn])/book/sectionadd/(\d+)/$',views.book_sectionadd,name='book_sectionadd'),
    url(r'^([novel|learn])/book/sectionadd/submit/$',views.section_add_submit,name='section_add_submit'),
    ...
    url(r'^([novel|learn])/book/sectionupd/submit/$',views.section_upd_submit,name='section_upd_submit'),
    url(r'^([novel|learn])/book/section/(\d+)/(\d+)/$',views.book_section,name='book_section'),
    url(r'^([novel|learn])/book/author/(\d+)/$',views.book_author,name='book_author'),
    url(r'^([image|audio|video])/index',views.audiovideo_index,name='audiovideo_index'),
    url(r'^([image|audio|video])/(\d+)/(\d+)/$',views.audiovideo_list,name='audiovideo_list'),
    url(r'^([image|audio|video])/content/(\d+)/(\d+)/$',views.audiovideo_content,name='audiovideo_content'),
#     url(r'^novel/download/(\d+)/$',views.novel_download,name='novel_download'),
#     url(r'^image/download/(\d+)/$',views.image_download,name='image_download'),
